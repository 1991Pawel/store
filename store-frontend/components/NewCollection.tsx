        ...
        <div className="wrapper">
            ...
            <ul className={styles.best__items}>
                <li className={styles.best__item}>
                    <button className={styles.best__btn}>discover</button>
                ...
                <li className={styles.best__item}>
                    <button className={styles.best__btn}>discover</button>
                    <img src="https://img01.ztat.net/article/spp-media-p1/c6afcbbdf2173c5da83cb65665ee2236/ffa99fb038674d0e92c2655ddb620333.jpg?imwidth=1800" alt="" />
                </li>
                <li className={styles.best__item}>
                    <button className={styles.best__btn}>discover</button>
